...
public class JobAdapter_marketing extends RecyclerView.Adapter<JobAdapter_marketing.JobViewHolder> {

    private Context context;
    private List<JobsAdModel> jobList1;
    private FirebaseFirestore mStore;
    public JobAdapter_marketing(Context context, List<JobsAdModel> jobList) {
    ...
    public JobViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.marketing_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull JobViewHolder holder, int position) {
        JobsAdModel job = jobList1.get(position);
